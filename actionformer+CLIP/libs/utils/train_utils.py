    ...
    for mn, m in model.named_modules():
        for pn, p in m.named_parameters():
            ...
            if pn.endswith('bias'):
                ...
                no_decay.add(fpn)
            elif 'module.backbone.embd' in mn and 'layers' in pn and pn.endswith('bn.weight'):
            # Add the specific parameters to the no_decay set
                no_decay.add(fpn)
            #elif 'module.backbone.embd' in mn and 'layers' in pn:
            # Add the specific parameters to the no_decay set
             #   no_decay.add(fpn)
